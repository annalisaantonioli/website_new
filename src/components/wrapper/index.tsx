    ...
    <>
      ...
      <div
        ...
        <div className='bg-accent md:bg-primary lg:bg-accent w-full h-[60vh] flex flex-col  justify-center px-8 text-light overflow-hidden'>
          ...
          <div className='lg:max-w-[500px] w-full py-8 md:pr-10' >
        ...
        <div className='flex items-center px-8 py-8 md:py-2 my-auto'>
        ...
        <div className='bg-primary px-8 py-3 text-light w-full'>
        ...
        <span className='text-xs px-8 py-1 inline-block text-right'>Copyright© {new Date().getFullYear()} | p.iva 11831300014</span>
      </div >
    </>
  )
